...
from .views import IndexView, RegisterView, LoginView, LogoutView, HomeView

flask_app.add_url_rule('/', view_func=IndexView.as_view('index'), methods=["GET"])
flask_app.add_url_rule('/home', view_func=IndexView.as_view('home'), methods=["GET"])
...
flask_app.add_url_rule('/logout', view_func=LoginView.as_view('logout'), methods=["GET"])
