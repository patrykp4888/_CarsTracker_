...
flask_app.add_url_rule('/logout', view_func=LogoutView.as_view('logout'), methods=["GET"])
flask_app.add_url_rule('/profile', view_func=ProfileView.as_view('profile'), methods=["GET", "POST"])
